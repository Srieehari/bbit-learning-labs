...
class mqProducer(mqProducerInterface):
    ...
    def __init__(self, routing_key: str, exchange_name: str, exchange_type: str = "topic") -> None:
    ...
    def setupRMQConnection(self) -> None:
        ...
        self.exchange = self.channel.exchange_declare(exchange=self.exchange_name, type=self.exchange_type)
